...
#### 🎮 [AI 推理游戏](https://github.com/Tao716/ai-mini-game)
...
- **AI 有没有必要** — 能用确定性规则解决的，不强行交给模型
- **边界怎么划分** — 模型负责理解与生成，工具负责状态与规则
- **原型能不能尽快验证** — 先做出能体验的版本，再按反馈改
- **结论能不能复盘** — 把事实、判断和未知项分开
