...
<p>
  ...
  &nbsp;·&nbsp; 📌 <a href="https://github.com/Tao716/Tao716#代表作品">查看代表作品</a>
</p>
...
| 🧩 [知乎黑客松项目](https://github.com/Tao716/zhihu-hackathon) | 将会议内容转成决策、任务与后续跟进，减少信息流失 | 用户场景 · 工作流设计 · 可交互产品 |
...
- **问题是不是真实**：先理解用户和场景，再决定要不要做。
- **AI 有没有必要**：能用确定性规则解决的事情，不强行交给模型。
- **边界怎么划分**：模型负责理解与生成，工具负责状态、规则和确定性结果。
- **原型能不能尽快验证**：先做出一个能体验的版本，再根据反馈继续改。
- **结论能不能复盘**：把事实、判断和未知项分开，方便下一次迭代。

## 🔭 最近在做

- 探索更自然的 **AI 原生交互**，让复杂的模型能力变成用户能理解、能控制的体验。
- 把产品拆解、用户研究和 Agent 设计沉淀成可复用的 **分析框架与 Skills**。
...
<details>
  ...
  <div align="center">
    <picture>
      ...
      <img alt="陶越的 GitHub 贡献图动画" src="https://raw.githubusercontent.com/Tao716/Tao716/output/github-contribution-grid-snake-dark.svg" />
    </picture>
  </div>
</details>
